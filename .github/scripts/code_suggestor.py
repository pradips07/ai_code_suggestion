...
for file in files:
    ...
    for idx, chunk in enumerate(patch_chunks):
        prompt = f"""
        You are a senior PHP/Javascript/CSS code reviewer. Suggest improvements for the following code, add 10 points:
        ...
        try:
            response = openai.chat.completions.create(
                model="gpt-4o-mini",
                messages=[
                    {"role": "system", "content": "You are a senior PHP/Javascript/CSS code reviewer, add 10 points."},
